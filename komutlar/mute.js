...
const ms = require("ms");
var mutelu = "761109013986410496"; //buraya muteli rolünün id'sini koyunuz
var muteyetkisi = "758427126952493116"; // buraya mute yetkis irolünün id yazınız.
  ...
  if (!msg.member.roles.has(muteyetkisi)) {
    ...
    if (!muted) {
      ...
      if (
        ...
        msg.reply("bu kullanıcıya mute atma yetkim yok.");
      } else {
